...
function MySqlQuery($SqlString, $ConnectionId = null)
{
...
class CSql {
	...
	public static function quote($str, $conn = null)
	{
	...
	public static function createConnection()
	{
		...
		//print " $ServerName, $WebUserName, $WebUserPassword, $DBName  ";
		$connection = mysqli_connect($ServerName, $WebUserName, $WebUserPassword, $DBName);

		if (!$connection) {
			self::dieOnSqlError(null, 'createConnection', 'mysql_connect: ', mysqli_connect_error());
		}
	...
	public static function singleRow($query, $ConnectionId = null)
	{
		$result = MySqlQuery($query, $ConnectionId);
		$row = mysqli_fetch_assoc($result);
		mysqli_free_result($result);
		return $row;
	}

	public static function singleValue($query, $key, $strict = true, $ConnectionId = null)
	{
		$result = MySqlQuery($query, $ConnectionId);
		$row = mysqli_fetch_assoc($result);
		mysqli_free_result($result);
	...
	public static function userId($sessionId, $ConnectionId = null)
	{
		...
		$sql = "select user_id from Sessions where session_id = " . CSql::quote($sessionId, $ConnectionId);	// см комментарий про эскейпинг к CMmbAuth::getUserId
		return self::singleValue($sql, 'user_id', false, $ConnectionId);
		CSql::closeConnection($ConnectionId);
	}
