...
print('<a name="help">После названия дистанции в скобках через слэш указывается число: команд (зелёным - "<a href="http://community.livejournal.com/_mmb_/2010/09/24/">нет сломанным унитазам</a>"), заказанных карт и участников.
