...
print('<a name = "help">Обычно за месяц до проведения ММБ в сеть выкладывается положение, за неделю - раскрывается место старта.<br/>
 После названия дистанции в скобках через слэш указывается число: команд (зелёным - "<a href = "http://community.livejournal.com/_mmb_/2010/09/24/">нет сломанным унитазам</a>"), заказнных карт и участников.
