...
/**
 * +++++++++++ Показ списка всех марш-бросков ++++++++++++++++++++++++++++++++++
 */
...
соревнования по туристскому ориентированию</div>' . "\r\n");
...
детали взяты из традиционного <a href = "https://kandid.ru">питерского Марш-броска</a> </p>' . "\r\n");
...
соревнования ночное ориентирование и различные неожиданности на дистанции. 
Обычно за месяц до проведения ММБ в сеть выкладывается положение, а за неделю раскрывается место старта.
Тем, кто ещё не участвовал в Марш-броске, рекомендуется изучить результаты и впечатления участников прошлогодних ММБ, 
серьёзно отнестись к подбору снаряжения (с учётом веса и с расчётом на неблагоприятные погодные условия), 
обдумать тактику прохождения дистанции. </p>' . "\r\n");
...
while ($rowRaids = mysqli_fetch_assoc($resultRaids)) {
    ...
    $RaidRulesLink = CSql::raidFileLink($nextRaidId, 1, true);  // ссылка на положение в загруженных файлах
...
print('<a name="help">После названия дистанции в скобках через слэш указывается число: команд (зелёным - "<a href="https://community.livejournal.com/-mmb-/2010/09/24/">нет сломанным унитазам</a>"), заказанных карт и участников.
 ...
 Карты дистанции выкладываются в разделе "Файлы", обновленные карты местности (без дистанции), а также векторные карты - смотрите в разделе "<a href="https://slazav.xyz/maps/podm.htm">Карты</a>"
' . "\r\n");
print("</p>\r\n");
