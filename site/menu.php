...
*/
	...
	print('<tr><td><div  style = "float:left;vertical-align: top;">используется</div> <a href="https://www.jetbrains.com/phpstorm/" target = "_blank"><img name = "icon_PhpStorm" style="margin-top: 0 px; border: none" alt="PhpStorm" width = "64" height = "64" src="'.trim($MyStoreHttpLink).'icon_PhpStorm.png"></a></td></tr>'."\r\n");
