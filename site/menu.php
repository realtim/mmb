...
*/
	...
	print('<tr><td style = "vertical-align:top">используется <a href="https://www.jetbrains.com/phpstorm/" target = "_blank"><img name = "icon_PhpStorm" style="border: none" alt="PhpStorm" width = "64" height = "64" src="'.trim($MyStoreHttpLink).'icon_PhpStorm.png"></a></td></tr>'."\r\n");
