...
public class TeamFilter extends Filter {
    ...
    public void initialize(List<TeamListRecord> sourceItems, TeamResultActivityState currentState) {
    ...
    private boolean checkMemberFilter(TeamListRecord item) {
        ...
        return item.getMemberText().toLowerCase().contains(currentState.getFilterPanelState().getMemberFilter().toLowerCase());
    }
