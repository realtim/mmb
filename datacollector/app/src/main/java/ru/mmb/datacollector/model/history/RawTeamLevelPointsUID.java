 ...
 * @author yweiss
 */
public class RawTeamLevelPointsUID implements Comparable<RawTeamLevelPointsUID>
{
	private final Date recordDateTime;
	private final Integer teamId;
	private final Integer userId;

	public RawTeamLevelPointsUID(RawTeamLevelPoints rawTeamLevelPoints)
	{
		recordDateTime = rawTeamLevelPoints.getRecordDateTime();
		teamId = rawTeamLevelPoints.getTeamId();
		userId = rawTeamLevelPoints.getUserId();
	}

	@Override
	public int compareTo(RawTeamLevelPointsUID another)
	{
	...
	public boolean equals(Object obj)
	{
		...
		RawTeamLevelPointsUID other = (RawTeamLevelPointsUID) obj;
